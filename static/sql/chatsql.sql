...
-- user테이블 테스트 데이터 입력
   ...
   INSERT INTO user (user_id, user_pw, user_name, user_email, prof_img_url) VALUES('contactor2', '1111', '채팅신청자2', 'test1@test.com','https://src.hidoc.co.kr/image/lib/2022/5/12/1652337370806_0.jpg');

ALTER TABLE user AUTO_INCREMENT = 1;

INSERT INTO board (user_index,title, parity,category_id, member_num,description,expr_dt,start_dt,end_dt,appo_area,createdAt, updatedAt) VALUES ('1', '테스트1', 'OFF','1', '5', '스터디 내용','20221122','20221130','20221201','염리동','20221122','20221121');
